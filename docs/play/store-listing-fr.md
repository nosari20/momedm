...
À coller dans Play Console → **Développement → Présence sur le Store →
Fiche Store principale**, langue Français (France). Comptages mesurés avec
`len()` en Python sur le texte exact. Mise à jour du 2026-08-26, alignée sur
l’appli livrée : installation guidée par étapes, lanceur pensé pour
l’enfant (ciel étoilé, vraie lune au coucher), permissions réduites.

Cette traduction reprend le vocabulaire déjà utilisé dans
`values-fr/strings.xml` (« Mode enfant », « Restrictions de contenu »,
« Code PIN parental », « Verrouillage la nuit ») — pas une traduction
mot à mot du texte anglais.
...
Installez Môme DM chez vous et chez l’enfant. Chez l’enfant, l’appli est mise en place lors d’une réinitialisation d’usine, comme propriétaire de l’appareil, et devient l’écran d’accueil. Chez vous, c’est un panneau de contrôle, avec une installation guidée pas à pas. Ensuite, les deux téléphones ne communiquent plus que par Bluetooth, à portée l’un de l’autre. Le Wi-Fi n’intervient qu’une fois, pour l’installation chez l’enfant.
...
• Choisir les applis autorisées. Les autres n’apparaissent pas sur l’écran d’accueil et ne peuvent pas être lancées. Possibilité de le limiter à une seule appli.

• Régler les restrictions de contenu. Trois niveaux — désactivé, modéré, strict — activent SafeSearch, la navigation sécurisée de Chrome et le mode restreint de YouTube, plus en option un filtrage DNS familial appliqué à tout le téléphone. L’appli explique ce que chaque réglage couvre, et ce qu’il ne couvre pas.

• Configurer d’autres applis. Beaucoup déclarent leurs propres réglages administrables (Chrome en déclare des centaines). Môme DM lit ce qu’une appli déclare et construit un formulaire pour la régler.
...
• Voir ce qui se passe. Applis autorisées, appli en cours d’usage (si l’accès à l’usage a été accordé), batterie, état du verrouillage.
...
- Conservez la puce `•`, les guillemets « français » et les apostrophes
  typographiques — cohérents avec les textes de l’appli.
- Si le compteur de Play Console diffère légèrement, faites-lui confiance et
  raccourcissez d’abord le dernier paragraphe.
